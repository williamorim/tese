...
Quando não for possível agregar os dados, a solução é considerar generalizações do modelo de regressão linear que contemplem a correlação dos dados, como os modelos mistos \citep{McCulloch2001, Demidenko2013}.

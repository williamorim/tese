...
No R, os modelos de regressão linear podem ser ajustados via mínimos quadrados com a função \texttt{lm()} do pacote \texttt{stats} ou utilizando o pacote \texttt{caret}, que traz um \textit{framework} padronizado para o ajuste de modelos estatísticos.
